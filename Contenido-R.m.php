...
<body>
        ...
        <ul class="list">
            ...
            <li class="list__item">
                <div class="list__button">
                    ...
                    <a href="../parte-roja-negra.php" class="nav__link">Fin</a>
                </div>
            </li>
    ...
    <div class="cursos">
        <div class="C1">
            <h4>Clase-1</h4>
            <p>RAZONAMIENTO MATEMÁTICO dolor, sit amet consectetur adipisicing elit. Commodi libero, inventore at asperiores voluptate esse mollitia quasi eaque temporibus officia facere quibusdam unde illo ex molestias explicabo tempora accusantium vitae.</p>
